...
the catalog rather than assuming it matched. Flagged every product that was in one and not
...
The catalog and the product list agree. That sounds small and it is the thing that stops
the same problem coming back every time something is added.
